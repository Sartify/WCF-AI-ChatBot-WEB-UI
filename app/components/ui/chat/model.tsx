...
export default function ChatMessages(
  ...
  return (
    <div className="w-full max-w-screen-lg mx-auto rounded-xl p-4 shadow-2xl drop-shadow-2xl pb-0 flex flex-col h-chat bg-white flex-grow">
      ...
      {props.messages.length > 0 ? null : (
        <div className="text-neutral-600 py-4 overflow-scroll text-sm flex flex-col gap-2 lg:gap-4">
          <div>
      ...
      <span className="rounded-lg hover:bg-red-500/30 p-[0.1rem] flex lg:h-[26px] lg:w-[26px] h-[22px] w-[22px]  mt-1.5 items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" className="icon-md-heavy">
          <path fill="red" d="M11.408 21.496a.99.99 0 0 1-1.06.485c-1.91-.384-3.073-2.342-2.5-4.212L8.697 15H6.986c-2.627 0-4.534-2.507-3.843-5.052l1.358-5A3.986 3.986 0 0 1 8.344 2h5.689a1.996 1.996 0 0 1 1.988 2v11h-.338a1 1 0 0 0-.865.504zM18.012 15A2.994 2.994 0 0 0 21 12V5c0-1.657-1.338-3-2.988-3h-.533c.34.588.533 1.271.533 2z">
          </path>
        </svg>
      </span>
      
      <span className="rounded-lg hover:bg-black/30 p-[0.1rem] flex lg:h-[26px] lg:w-[26px] h-[22px] w-[22px] items-center justify-center">
         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" className="icon-md-heavy">
           <path fill="currentColor" d="M12.592 2.504a.99.99 0 0 1 1.06-.485c1.91.384 3.073 2.342 2.5 4.212L15.303 9h1.711c2.627 0 4.534 2.507 3.843 5.052l-1.358 5A3.986 3.986 0 0 1 15.656 22h-5.689a1.996 1.996 0 0 1-1.988-2v-11h.338a1 1 0 0 0 .865-.504zM5.988 9A2.994 2.994 0 0 1 3 12v7c0 1.657 1.338 3 2.988 3h.533c-.34-.588-.533-1.271-.533-2z"></path>
         </svg>
       </span>
      </div>
        )}
        ...
        <div className="flex-1 text-center">
          {errorMessage && (
            <div className="bg-red-500/40 lg:p-3 p-1 rounded-md flex tems-center justify-center gap-x-2 text-sm text-red-500 lg:w-1/2 mx-auto">
